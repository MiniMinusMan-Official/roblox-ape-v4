...
-- END Blatant/AntiFall.lua

-- BEGIN Blatant/Fly.lua
local Fly
local LongJump
run(function()
...
-- END Blatant/HighJump.lua

-- BEGIN Blatant/HitBoxes.lua
local HitBoxes
local Targets
local TargetPart
local Expand
...
-- END Blatant/HitBoxes.lua

-- BEGIN Blatant/Invisible.lua
local Invisible
local oldcf
local animtrack
local proper = true
...
-- END Blatant/Invisible.lua

-- BEGIN Blatant/Jesus.lua
local Jesus
...
-- END Blatant/Jesus.lua

-- BEGIN Blatant/Killaura.lua
local Killaura
local Targets
local CPS
local SwingRange
...
-- END Blatant/Killaura.lua

-- BEGIN Blatant/LongJump.lua
local Mode
local Value
local AutoDisable
...
-- END Blatant/LongJump.lua

-- BEGIN Blatant/MouseTP.lua
local MouseTP
local Mode
local MovementMode
local Length
...
-- END Blatant/MouseTP.lua

-- BEGIN Blatant/Phase.lua
local Mode
...
-- END Blatant/Phase.lua

-- BEGIN Blatant/Speed.lua
local Speed
local Mode
local Options
local AutoJump
...
-- END Blatant/Speed.lua

-- BEGIN Blatant/Spider.lua
local Mode
local Value
local State
local rayCheck = RaycastParams.new()
...
-- END Blatant/Spider.lua

-- BEGIN Blatant/SpinBot.lua
local SpinBot
local Mode
local XToggle
local YToggle
...
-- END Blatant/SpinBot.lua

-- BEGIN Blatant/Swim.lua
local Swim
...
-- END Blatant/Swim.lua

-- BEGIN Blatant/TargetStrafe.lua
local TargetStrafe
local Targets
local SearchRange
local StrafeRange
...
-- END Blatant/TargetStrafe.lua

-- BEGIN Blatant/Timer.lua
local Timer
local Value
...
-- END Blatant/Timer.lua

-- BEGIN Combat/AimAssist.lua
local AimAssist
local Targets
local Part
local FOV
...
-- END Combat/AimAssist.lua

-- BEGIN Combat/AutoClicker.lua
local AutoClicker
local Mode
local CPS
...
-- END Combat/AutoClicker.lua

-- BEGIN Combat/Reach.lua
local Reach
local Targets
local Mode
local Value
...
-- END Combat/Reach.lua

-- BEGIN Combat/SilentAim.lua
local mouseClicked
run(function()
	local SilentAim
	local Target
...
-- END Combat/SilentAim.lua

-- BEGIN Combat/TriggerBot.lua
local TriggerBot
local Targets
local ShootDelay
local Distance
...
-- END Combat/TriggerBot.lua

-- BEGIN Legit/Atmosphere.lua
local Atmosphere
local Toggles = {}
...
-- END Legit/Atmosphere.lua

-- BEGIN Legit/Breadcrumbs.lua
local Breadcrumbs
local Texture
local Lifetime
local Thickness
...
-- END Legit/Breadcrumbs.lua

-- BEGIN Legit/Cape.lua
local Cape
local Texture
local part, motor
...
-- END Legit/ChinaHat.lua

-- BEGIN Legit/Clock.lua
local Clock
...
-- END Legit/Keystrokes.lua

-- BEGIN Legit/Memory.lua
local Memory
local label
...
corner.CornerRadius = UDim.new(0, 4)
corner.Parent = label
-- END Legit/Memory.lua

-- BEGIN Legit/Ping.lua
local Ping
local label
...
-- END Legit/SongBeats.lua

-- BEGIN Legit/Speedmeter.lua
local Speedmeter
local label
...
corner.CornerRadius = UDim.new(0, 4)
corner.Parent = label
-- END Legit/Speedmeter.lua

-- BEGIN Legit/TimeChanger.lua
local TimeChanger
local Value
local old
...
-- END Legit/TimeChanger.lua

-- BEGIN Minigames/MurderMystery.lua
local MurderMystery
...
-- END Minigames/MurderMystery.lua

-- BEGIN Render/Arrows.lua
local Arrows
local Targets
local Color
local Teammates
...
-- END Render/Arrows.lua

-- BEGIN Render/Chams.lua
local Chams
local Targets
local Mode
local FillColor
...
-- END Render/Chams.lua

-- BEGIN Render/ESP.lua
local ESP
local Targets
local Color
local Method
...
-- END Render/Fullbright.lua

-- BEGIN Render/GamingChair.lua
...
-- END Render/GamingChair.lua

-- BEGIN Render/Health.lua
local Health
...
-- END Render/Health.lua

-- BEGIN Render/NameTags.lua
local NameTags
local Targets
local Color
local Background
...
-- END Render/NameTags.lua

-- BEGIN Render/PlayerModel.lua
local PlayerModel
local Scale
local Local
local Mesh
...
-- END Render/PlayerModel.lua

-- BEGIN Render/Radar.lua
local Radar
local Targets
local DotStyle
local PlayerColor
...
-- END Render/Radar.lua

-- BEGIN Render/Search.lua
local Search
local List
local Color
local FillTransparency
...
-- END Render/Search.lua

-- BEGIN Render/SessionInfo.lua
local SessionInfo
local FontOption
local Hide
local TextSize
...
-- END Render/SessionInfo.lua

-- BEGIN Render/Tracers.lua
local Tracers
local Targets
local Color
local Transparency
...
-- END Render/Tracers.lua

-- BEGIN Render/Waypoints.lua
local Waypoints
local FontOption
local List
local Color
...
-- END Render/Waypoints.lua

-- BEGIN Utility/AnimationPlayer.lua
...
-- END Utility/AnimationPlayer.lua

-- BEGIN Utility/AntiRagdoll.lua
local AntiRagdoll
...
-- END Utility/AntiRagdoll.lua

-- BEGIN Utility/AutoRejoin.lua
local AutoRejoin
local Sort
...
-- END Utility/AutoRejoin.lua

-- BEGIN Utility/Blink.lua
local Blink
local Type
local AutoSend
...
-- END Utility/Blink.lua

-- BEGIN Utility/ChatSpammer.lua
local ChatSpammer
local Lines
local Mode
local Delay
...
-- END Utility/ChatSpammer.lua

-- BEGIN Utility/Disabler.lua
local Disabler
...
-- END Utility/Disabler.lua

-- BEGIN Utility/Panic.lua
...
-- END Utility/Panic.lua

-- BEGIN Utility/Rejoin.lua
local Rejoin
...
-- END Utility/Rejoin.lua

-- BEGIN Utility/ServerHop.lua
local ServerHop
local Sort
...
-- END Utility/ServerHop.lua

-- BEGIN Utility/StaffDetector.lua
local StaffDetector
local Mode
local Profile
local Users
...
-- END Utility/StaffDetector.lua

-- BEGIN Utility/StateSpoofer.lua
local StateSpoofer
local State
local hook
...
-- END Utility/StateSpoofer.lua

-- BEGIN World/Anti-AFK.lua
local connections = {}
...
-- END World/Anti-AFK.lua

-- BEGIN World/FastProxPrompt.lua
...
-- END World/FastProxPrompt.lua

-- BEGIN World/Freecam.lua
local Freecam
local Value
...
-- END World/Freecam.lua

-- BEGIN World/Gravity.lua
local Gravity
local Mode
local Value
...
-- END World/Gravity.lua

-- BEGIN World/Parkour.lua
local Parkour
...
-- END World/Parkour.lua

-- BEGIN World/SafeWalk.lua
local rayCheck = RaycastParams.new()
rayCheck.RespectCanCollide = true
local module, old
...
-- END World/SafeWalk.lua

-- BEGIN World/Wallhop.lua
local Wallhop
local Offset
...
-- END World/Wallhop.lua

-- BEGIN World/Xray.lua
local Xray
local List
local modified = {}
