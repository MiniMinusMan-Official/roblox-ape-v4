...
icon.Image = getcustomasset('newvape/assets/liquidbounce/targetstab.png')
icon.Parent = window
...
optionapi.Players = components.TargetsButton({
	...
	Icon = getcustomasset('newvape/assets/liquidbounce/targetplayers1.png'),
	IconSize = UDim2.fromOffset(15, 16),
	IconParent = tool,
	ToolIcon = getcustomasset('newvape/assets/liquidbounce/targetplayers2.png'),
...
optionapi.NPCs = components.TargetsButton({
	...
	Icon = getcustomasset('newvape/assets/liquidbounce/targetnpc1.png'),
	IconSize = UDim2.fromOffset(12, 16),
	IconParent = tool,
	ToolIcon = getcustomasset('newvape/assets/liquidbounce/targetnpc2.png'),
