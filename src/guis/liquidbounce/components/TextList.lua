...
bkg.BackgroundColor3 = uipallet.PanelLight
bkg.Parent = textlist
...
button.BackgroundColor3 = uipallet.Panel
...
buttonicon.Image = optionsettings.Icon or getcustomasset('newvape/assets/liquidbounce/allowedicon.png')
...
icon.Image = optionsettings.Tab or getcustomasset('newvape/assets/liquidbounce/allowedtab.png')
icon.Parent = window
...
addbutton.Image = getcustomasset('newvape/assets/liquidbounce/add.png')
...
function optionapi:ChangeValue(val)
	...
	for i, v in self.List do
		...
		object.BackgroundColor3 = uipallet.PanelLight
		...
		objectbkg.BackgroundColor3 = uipallet.Panel
		...
		objectdot.BackgroundColor3 = enabled and optionsettings.Color or uipallet.Muted
		...
		objectdotin.BackgroundColor3 = enabled and optionsettings.Color or uipallet.Panel
		...
		close.Image = getcustomasset('newvape/assets/liquidbounce/closemini.png')
		...
		object.MouseButton1Click:Connect(function()
			...
			if ind then
				table.remove(self.ListEnabled, ind)
				objectdot.BackgroundColor3 = uipallet.Muted
				objectdotin.BackgroundColor3 = uipallet.Panel
			else
...
addvalue.MouseLeave:Connect(function()
	tween:Tween(addbkg, uipallet.Tween, {
		BackgroundColor3 = uipallet.PanelLight
	})
end)
--close.MouseButton1Click:Connect(function()
--	window.Visible = false
...
button.MouseButton1Click:Connect(function()
	...
	tween:Cancel(bkg)
	bkg.BackgroundColor3 = window.Visible and Color3.fromHSV(mainapi.GUIColor.Hue, mainapi.GUIColor.Sat, mainapi.GUIColor.Value) or uipallet.PanelLight
end)
