...
preview.Image = getcustomasset('newvape/assets/liquidbounce/colorpreview.png')
...
expand.Image = getcustomasset('newvape/assets/liquidbounce/expandicon.png')
...
rainbow1.Image = getcustomasset('newvape/assets/liquidbounce/rainbow_1.png')
rainbow1.ImageColor3 = color.Light(uipallet.Main, 0.37)
rainbow1.Parent = rainbow
local rainbow2 = rainbow1:Clone()
rainbow2.Image = getcustomasset('newvape/assets/liquidbounce/rainbow_2.png')
rainbow2.Parent = rainbow
local rainbow3 = rainbow1:Clone()
rainbow3.Image = getcustomasset('newvape/assets/liquidbounce/rainbow_3.png')
rainbow3.Parent = rainbow
local rainbow4 = rainbow1:Clone()
rainbow4.Image = getcustomasset('newvape/assets/liquidbounce/rainbow_4.png')
