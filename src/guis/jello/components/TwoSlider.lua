...
values.Size = UDim2.new(0.5, -8, 0, 24)
values.Position = UDim2.new(0.5, 0, 0, 1)
...
minKnob.Size = UDim2.fromOffset(12, 12)
minKnob.Position = UDim2.fromOffset(-6, -4)
...
maxKnob.Position = UDim2.new(1, -6, 0, -4)
maxKnob.Parent = fill
